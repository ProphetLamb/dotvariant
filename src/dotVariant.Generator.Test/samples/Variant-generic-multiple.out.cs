...
namespace Foo
{
        ...
        , global::System.IDisposable
    {
        ...
        /// <summary>Compare two Variant<T1, T2, T3> objects for equality.</summary>
        /// <param name="lhs">The first <see cref="Variant<T1, T2, T3>" /> to compare.</param>
        /// <param name="rhs">The second <see cref="Variant<T1, T2, T3>" /> to compare.</param>
        ...
        /// <seealso cref="Equals(Variant<T1, T2, T3>?)" />
        [global::System.Diagnostics.DebuggerNonUserCode]
        public static bool operator ==(Variant<T1, T2, T3>? lhs, Variant<T1, T2, T3>? rhs)
            => lhs?.Equals(rhs) ?? (rhs is null);

        /// <summary>Compare two Variant<T1, T2, T3> objects for inequality.</summary>
        /// <param name="lhs">The first <see cref="Variant<T1, T2, T3>" /> to compare.</param>
        /// <param name="rhs">The second <see cref="Variant<T1, T2, T3>" /> to compare.</param>
...
namespace Foo
{
    ...
    /// </summary>
    public static partial class Variant_T1_T2_T3_VariantExtensions
    {
        /// <summary>
