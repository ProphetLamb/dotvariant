...
namespace Foo
{
        ...
        : global::System.IEquatable<Variant_nullable_value_type>
    {
        ...
        /// <summary>Compare two Variant_nullable_value_type objects for equality.</summary>
        /// <param name="lhs">The first <see cref="Variant_nullable_value_type" /> to compare.</param>
        /// <param name="rhs">The second <see cref="Variant_nullable_value_type" /> to compare.</param>
        ...
        /// <seealso cref="Equals(Variant_nullable_value_type?)" />
        [global::System.Diagnostics.DebuggerNonUserCode]
        public static bool operator ==(Variant_nullable_value_type? lhs, Variant_nullable_value_type? rhs)
            => lhs?.Equals(rhs) ?? (rhs is null);

        /// <summary>Compare two Variant_nullable_value_type objects for inequality.</summary>
        /// <param name="lhs">The first <see cref="Variant_nullable_value_type" /> to compare.</param>
        /// <param name="rhs">The second <see cref="Variant_nullable_value_type" /> to compare.</param>
...
namespace Foo
{
    ...
    /// </summary>
    public static partial class Variant_nullable_value_type_VariantExtensions
    {
        /// <summary>
